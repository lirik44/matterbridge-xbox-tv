...
export default defineConfig([
  ...
  pluginPrettierRecommended, // Prettier plugin must be the last plugin in the list
  {
    ...
    rules: {
      ...
      // Node 20 ships a working global fetch; the plugin only flags it as experimental.
      'n/no-unsupported-features/node-builtins': ['error', { ignores: ['fetch', 'Response'] }], // Both are stable in the Node 20 the plugin requires; the rule is a version behind
